...
async function loadModules() {
  const parserModule = await import('../../js/transpiler/transpiler/parser.js');
  JavaScriptParser = parserModule.JavaScriptParser;

  const analyzerModule = await import('../../js/transpiler/transpiler/analyzer.js');
  SemanticAnalyzer = analyzerModule.SemanticAnalyzer;

  const codegenModule = await import('../../js/transpiler/transpiler/codegen.js');
