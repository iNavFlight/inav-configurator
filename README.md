...
You have to remove the `C:\Users%Your_UserNname%\AppData\Local\inav-configurator` folder and all its content.
...
1. Click the **Settings** icon in the top-right corner of INAV Configurator
