    ...
    function process_html() {
       ...
       i18n.localize();
        ...
        function update_ui() {
            ...
            // The flight controller reports MANUAL as active for the whole connection,
            // so only a switch-selected MANUAL range should block ACRO.
            ...
            for (var i = 0; i < LOCAL_AUX_CONFIG.length; i++) {
                ...
                for (let r = 0; r < modeRanges.length; r++) {
                    ...
                    var markerPosition = Number.parseFloat($(modeRanges[r]).find('.marker')[0].style.left);
