...
async function loadModules() {
  const parserMod = await import('../../js/transpiler/transpiler/parser.js');
  JavaScriptParser = parserMod.JavaScriptParser;

  const helperMod = await import('../../js/transpiler/transpiler/arrow_function_helper.js');
  ArrowFunctionHelper = helperMod.ArrowFunctionHelper;

  const utilsMod = await import('../../js/transpiler/transpiler/expression_utils.js');
